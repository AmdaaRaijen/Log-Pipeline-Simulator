/* @ts-self-types="./vrl_wasm.d.ts" */

class VrlResult {
    static __wrap(ptr) {
        const obj = Object.create(VrlResult.prototype);
        obj.__wbg_ptr = ptr;
        VrlResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VrlResultFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_vrlresult_free(ptr, 0);
    }
    /**
     * @returns {boolean}
     */
    get success() {
        const ret = wasm.__wbg_get_vrlresult_success(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set success(arg0) {
        wasm.__wbg_set_vrlresult_success(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {string}
     */
    get output() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vrlresult_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) VrlResult.prototype[Symbol.dispose] = VrlResult.prototype.free;
exports.VrlResult = VrlResult;
 ...
 * @returns {VrlResult}
 */
function evaluate_vrl(program_str, input_json) {
    ...
    const ret = wasm.evaluate_vrl(ptr0, len0, ptr1, len1);
    return VrlResult.__wrap(ret);
}
exports.evaluate_vrl = evaluate_vrl;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./vrl_wasm_bg.js": import0,
    };
}

const VrlResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vrlresult_free(ptr, 1));
...
const wasmPath = require("path").join(process.cwd(), "lib", "vrl-wasm-pkg", "vrl_wasm_bg.wasm");
